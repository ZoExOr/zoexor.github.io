...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          handler: () => {
        ...
        },{id: "dropdown-books-i-39-ve-read",
            ...
            },{id: "dropdown-my-artistic-creations",
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/ZoExOr", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/yijun-zoe-zhou-412170297", "_blank");
        },
      },{
      id: 'light-theme',
